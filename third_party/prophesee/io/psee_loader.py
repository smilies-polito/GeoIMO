...
class PSEELoader(object):
    ...
    def __init__(self, datfile):
        ...
        # print('type(self._ev_size) = {}'.format(type(self._ev_size)))
        ...
        # print('_ev_count.type = {}'.format(type(self._ev_count)))
        # print('_end.type = {}'.format(type(self._end)))
        # print('_start.type = {}'.format(type(self._start)))
        # print('self._ev_size.type = {}'.format(type(self._ev_size)))
        # print('_ev_size = {}'.format(self._ev_size))
